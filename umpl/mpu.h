...
#include "../HardwareProfile.h" //Get the device selection
...
// struct below modified by Stephen Allen 9/26/11

// original
//struct mpu_platform_data {
//	unsigned char int_config;
//	unsigned char level_shifter;
//	unsigned char orientation[GYRO_NUM_AXES * GYRO_NUM_AXES];
//};
